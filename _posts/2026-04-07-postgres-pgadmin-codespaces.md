...
While the browser experience is excellent, you might prefer working in your local **Visual Studio Code** application. The integration is seamless as we simply select `Open in VS Code Desktop` by clicking the "more options" icon `[...]` in the Codespace we created.
...
![alt text](/images/posts/2026-04-07-postgres-pgadmin-codespaces/4-running-containers.png "Running Containers")
...
![alt text](/images/posts/2026-04-07-postgres-pgadmin-codespaces/5-pgadmin-settings.png "pgAdmin")
...
![alt text](/images/posts/2026-04-07-postgres-pgadmin-codespaces/6-db-test.png "db-test")
